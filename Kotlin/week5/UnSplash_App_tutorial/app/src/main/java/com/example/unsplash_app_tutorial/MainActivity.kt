    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_search.setOnClickListener{
            ...
            RetrofitManager.instance.searchPhotos(searchTerm=search_term_edit_text.text.toString(),completion={
                responseState,responseDatatArrayList ->

                when(responseState){
                    RESPONSE_STATUS.OKAY->{
                        Log.d(TAG,"api 호출 성공 : ${responseDatatArrayList?.size}")

                        val intent= Intent(this,PhotoCollectionActivity::class.java)
                        val bundle=Bundle()
                        bundle.putSerializable("photo_array_list",responseDatatArrayList)
                    ...
                    RESPONSE_STATUS.FAIL->{
                        ...
                        Log.d(TAG,"api 호출 실패 : $responseDatatArrayList")
                    }
