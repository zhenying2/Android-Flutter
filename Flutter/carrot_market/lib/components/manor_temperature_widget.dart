  ...
  Widget _makeTemLabelAndBar(){
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text("${manorTemp}ºC",style: TextStyle(color: tempColors[level],fontSize: 18,fontWeight: FontWeight.bold)),
          ClipRRect(
            borderRadius: BorderRadius.circular(10),
            child: Container(height: 6,color: Colors.black.withOpacity(0.2),child: Row(children: [
              Container(height: 6,width: 60/99*manorTemp,color: tempColors[level],)
            ],),),
          )
        ],
      ),
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Column(
        ...
        Text("매너온도",style: TextStyle(fontSize: 12,color: Colors.grey,decoration: TextDecoration.underline),)
      ],
      ),
    );
  }
